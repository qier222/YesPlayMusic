export default {
  ...
  settings: {
    ...
    desktopLyrics: {
      ...
      enable: 'Enable Desktop Lyrics',
      alwaysOnTop: 'Always on Top',
      lock: 'Lock Desktop Lyrics',
      lockDescription:
        'Locked lyrics are click-through where the platform supports it. Unlock from this setting or the global shortcut.',
      fontSize: 'Font Size',
      opacity: 'Opacity',
      currentColor: 'Current Line Color',
      nextColor: 'Next Line Color',
