export default {
  ...
  settings: {
    ...
    desktopLyrics: {
      title: 'Masaüstü sözleri',
      enable: 'Masaüstü sözlerini etkinleştir',
      alwaysOnTop: 'Her zaman üstte',
      lock: 'Masaüstü sözlerini kilitle',
      lockDescription:
        'Kilitliyken pencere taşınamaz ve platform destekliyorsa tıklama arkaya geçer. Buradan veya kısayoldan tekrar açabilirsiniz.',
      fontSize: 'Yazı boyutu',
      opacity: 'Saydamlık',
      currentColor: 'Geçerli satır rengi',
      nextColor: 'Sonraki satır rengi',
      toggle: 'Masaüstü sözleri',
    },
